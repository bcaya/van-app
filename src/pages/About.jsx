...
import {Box, Cluster,Frame, Stack} from '../assets/CSS/StylesMain'
const imgUrl = "src/assets/about-image.jpg"

export default function About(){
  return ( 
    <box-l className="about-page-container">
            <stack-l>
    <box-l>
            <h1>Go on a VanVentures!</h1>
    ...
    <frame-l ratio="16:9" className="frame">
        <img src={imgUrl} />
          ...
          <box-l className="about-page-content">
          <cluster-l>
            <h2>How It Works</h2>
          <div role="list">
